...
//	set_record(SECTION_SECTION_CHARACTERISTICS, IMAGE_SCN_ALIGN_8192BYTES		, "Align data 8192-byte boundary (object)");
	...
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_ABSOLUTE	, "IMAGE_REL_I386_ABSOLUTE: Ignored");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_DIR16		, "IMAGE_REL_I386_DIR16: Not supported");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_REL16		, "IMAGE_REL_I386_REL16: Not supported");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_DIR32		, "IMAGE_REL_I386_DIR32: Target is 32bits VA");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_DIR32NB	, "IMAGE_REL_I386_DIR32NB: Target is 32bits RVA");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_SEG12		, "IMAGE_REL_I386_SEG12: Not supported");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_SECTION	, "IMAGE_REL_I386_SECTION: 16bits section index (Debug)");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_SECREL	, "IMAGE_REL_I386_SECREL");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_TOKEN		, "IMAGE_REL_I386_TOKEN");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_SECREL7	, "IMAGE_REL_I386_SECREL7");
	set_record(SECTION_COFF_RELOC, IMAGE_REL_I386_REL32		, "IMAGE_REL_I386_REL32");
}
